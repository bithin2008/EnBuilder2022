...
@Component({
    selector: 'app-type-deficiency',
    templateUrl: './type-deficiency.component.html',
    styleUrls: ['./type-deficiency.component.css']
})
export class TypeDeficiencyComponent implements OnInit {
    ...
    getSavedFilterdata() {
        ...
        let filterData: any = localStorage.getItem('serviceSettingsTypeDeficiencyFilterData');
        if (filterData) {
    ...
    getItemslist() {
        this.saveFilter();
        this.spinnerService.show();
        let url = `service/project-settings?type=PROJECT-DEFICIENCY-TYPES&page=${this.page}&pageSize=${this.pageSize}`;
        if (this.sortedtby)
    ...
    saveFilter() {
        ...
        localStorage.setItem('serviceSettingsTypeDeficiencyFilterData', JSON.stringify(data));
    }
