...
export class PriorityComponent implements OnInit {
    ...
    getSavedFilterdata() {
        ...
        let filterData: any = localStorage.getItem('serviceSettingsPriorityFilterData');
        if (filterData) {
    ...
    getItemslist() {
        this.saveFilter();
        this.spinnerService.show();
        let url = `service/project-settings?type=PROJECT-ISSUE-PRIORITY&page=${this.page}&pageSize=${this.pageSize}`;
        if (this.sortedtby)
    ...
    saveFilter() {
        ...
        localStorage.setItem('serviceSettingsPriorityFilterData', JSON.stringify(data));
    }
