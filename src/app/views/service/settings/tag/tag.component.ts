...
export class TagComponent implements OnInit {
    ...
    getSavedFilterdata() {
        ...
        let filterData: any = localStorage.getItem('serviceSettingsTagsFilterData');
        if (filterData) {
    ...
    getItemslist() {
        this.saveFilter();
        this.spinnerService.show();
        let url = `service/project-settings?type=PROJECT-ISSUE-TAG&page=${this.page}&pageSize=${this.pageSize}`;
        if (this.sortedtby)
    ...
    saveFilter() {
        ...
        localStorage.setItem('serviceSettingsTagsFilterData', JSON.stringify(data));
    }
